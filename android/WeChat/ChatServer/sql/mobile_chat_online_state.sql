...
--
-- Table structure for table `online_state`
--
...
--
-- Dumping data for table `online_state`
--

LOCK TABLES `online_state` WRITE;
/*!40000 ALTER TABLE `online_state` DISABLE KEYS */;
/*!40000 ALTER TABLE `online_state` ENABLE KEYS */;
UNLOCK TABLES;
